...
const setEmployeePayrollObject = () => {
  ...
  employeePayrollDataObject._email = getInputValueById('#mail');
  employeePayrollDataObject._phone = getInputValueById('#phone');
  employeePayrollDataObject._Empid = getInputValueById('#Empid');
...
const setForm = () => {
  ...
  setValue('#mail', employeePayrollDataObject._email);
  setValue('#phone', employeePayrollDataObject._phone);
  setValue('#Empid', employeePayrollDataObject._Empid);
